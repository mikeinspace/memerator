      ...
      <div className="App App-header">
        { this.state.url && 
          <div>
            ...
            <p class="xchainDetails">Asset Details: <a href="javascript:window.location.replace('https://xchain.io/asset'+window.location.pathname);">https://xchain.io/asset{ window.location.pathname }</a></p>
