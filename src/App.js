      ...
      <div className="App App-header">
        { this.state.url && 
          <div>
            ...
            <p class="xchainDetails">Asset Details: <a href="javascript:window.open('https://xchain.io/asset'+window.location.pathname);" onclick="alert(window.location.pathname);">https://xchain.io/asset{ window.location.pathname }</a></p>
